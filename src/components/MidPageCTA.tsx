...
const MidPageCTA = () => {
  return (
    <section className="px-6 py-8">
      <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-primary/45 via-primary/25 to-violet-500/35 p-px shadow-[0_24px_60px_-28px_hsl(var(--primary)/0.35)]">
        <div className="rounded-[calc(1rem-1px)] bg-card/95 px-6 py-10 text-center backdrop-blur-sm sm:px-10">
